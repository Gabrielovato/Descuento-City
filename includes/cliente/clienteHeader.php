...
<body>
    <header class="header">
        <div class="header_log-container">
            <a href="/Descuento-City/includes/cliente/clienteHeader.php"><img src="/Descuento-City/assets/img/logo/LOGO1.png" alt="logo"></a>
        </div>
        <nav class="header__nav">
            <ul class="header__nav-list">
                <li class="header__nav-item"><a href="#inicio">Inicio</a></li>
                <li class="header__nav-item"><a href=/Descuento-City/views/cliente/promocionesCliente.php">Promociones</a></li>
