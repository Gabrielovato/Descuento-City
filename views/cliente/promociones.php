...
<!-- Portada -->
    <section class="portada position-relative">
        <img src="/Descuento-City/assets/img/promociones-portada.png" alt="Portada de la seccion Promociones"class="portada-img img-fluid">
            ...
            while($promo = mysqli_fetch_assoc($resultado_promos)){
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <img src="/Descuento-City/<?= htmlspecialchars($promo["rutaArchivo"]) ?>" class="card-img-top img-fluid" alt="portada de la promocion" style="height: 250px; object-fit: cover; width: 100%;"> 
                        <?php else: ?>
